    ...
    return (
        ...
        >
            {data.values.map((v, i) => (
                ...
                >
                    <div
                        style={{ fontSize: 12, fontWeight: 600, color: C.navy }}
                    >
                        {v}%
                    </div>
                    <div
