...
export default function SurveiIndex({
    surveys,
    employees,
    kpis,
}: SurveiIndexProps) {
    ...
    const submitRespond = (event: FormEvent<HTMLFormElement>) => {
        ...
        router.post(
            ...
            {
                employee_id: selected.is_anonymous
                    ? null
                    : respondEmployee || null,
            ...
            <div style={{ padding: '28px 32px' }}>
                ...
                >
                    <div>
                        ...
                        >
                            Buat survei, susun pertanyaan, dan pantau respons.
                        </div>
                    </div>
                    <button
                        onClick={() => {
                    ...
                    >
                        ...
                        >
                            ...
                            <div style={{ fontSize: 14 }}>
                                Belum ada survei. Buat survei pertama Anda.
                            </div>
                        </div>
                    </div>
                ) : (
                                ...
                                <div style={{ ...card, padding: 20 }}>
                                    ...
                                    >
                                        ...
                                        {selected.questions.length === 0 && (
                                            ...
                                            >
                                                Belum ada pertanyaan. Tambahkan
                                                di bawah.
                                            </div>
                                        )}
            ...
            {createOpen && (
                ...
                >
                    ...
                    >
                        ...
                        >
                            Mulai survei baru untuk karyawan.
                        </div>
                        ...
                        >
                            ...
                            {selected.questions.length === 0 && (
                                <div style={{ fontSize: 13, color: C.faint }}>
                                    Survei ini belum punya pertanyaan.
                                </div>
                            )}
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            beserta pertanyaan dan responsnya akan dihapus
                            permanen.
                        </div>
                        <div
                            style={{ display: 'flex', gap: 10, marginTop: 22 }}
