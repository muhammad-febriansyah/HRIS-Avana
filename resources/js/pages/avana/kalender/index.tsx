...
export default function KalenderIndex({
    ...
    const submit = (e: FormEvent<HTMLFormElement>) => {
        ...
        const action = editing
            ? CalendarController.update(editing.id)
    ...
    const remove = () => {
        ...
        router.delete(CalendarController.destroy(editing.id).url, {
            preserveScroll: true,
            onSuccess: () => closeModal(),
        });
    };
            ...
            <div style={{ padding: '28px 32px' }}>
                ...
                >
                    <div>
                        ...
                        >
                            {kpis.this_month} acara pada bulan ini.
                        </div>
                    </div>
                    <button
                ...
                >
                    {types.map((t) => {
                        const [color] =
                            TYPE_COLORS[t.value] ?? TYPE_COLORS.event;
            ...
            {modalOpen && (
                ...
                >
                    ...
                    >
                        ...
                        >
                            {editing ? 'Ubah Acara' : 'Tambah Acara'}
                        </div>
                        <div
                            style={{
                                fontSize: 13,
                        ...
                        >
                            Catat agenda, libur, rapat, atau tenggat.
                        </div>
