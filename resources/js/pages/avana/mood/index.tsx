...
function indexLabel(index: number | null): string {
    ...
    if (index >= 80) {
        return 'Tim dalam kondisi prima';
    }

    if (index >= 60) {
        return 'Suasana tim positif';
    }
...
export default function AvanaMood({
    date,
    summary,
    employees,
    trend,
                ...
                <div style={{ marginBottom: 22 }}>
                    ...
                    >
                        <div>
                            ...
                            >
                                Rekap check-in perasaan harian karyawan dari
                                aplikasi — anonim antar rekan, hanya untuk HR.
                            </div>
                        </div>
                        <label
                            style={{
