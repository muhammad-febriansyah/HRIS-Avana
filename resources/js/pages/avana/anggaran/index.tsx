...
export default function AnggaranIndex({
    ...
    const submit = (e: FormEvent<HTMLFormElement>) => {
        ...
        const action = editing
            ? BudgetController.update(editing.id)
    ...
    const remove = () => {
        ...
        router.delete(BudgetController.destroy(confirm.id).url, {
            preserveScroll: true,
    ...
    const kpiItems = [
        {
            label: 'Total Rencana',
            value: rp(kpis.total_planned),
            icon: 'target',
            color: C.primary,
        },
        {
            label: 'Total Realisasi',
            value: rp(kpis.total_actual),
            icon: 'wallet',
            color: C.sky,
        },
        {
            label: 'Terpakai',
            value: `${kpis.usage_percent}%`,
            icon: 'gauge',
            color: kpis.usage_percent > 100 ? C.red : C.green,
        },
    ];
            ...
            {modalOpen && (
                ...
                >
                    ...
                    >
                        ...
                        >
                            {editing ? 'Ubah Anggaran' : 'Tambah Anggaran'}
                        </div>
                        <div
                            style={{
                                fontSize: 13,
                        ...
                        >
                            Tetapkan rencana dan realisasi anggaran.
                        </div>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="cth: 2026-07 atau 2026"
                                    style={{
                                        ...inputStyle,
                                        ...(form.errors.period
                                            ? { borderColor: C.red }
                            ...
                            >
                                <div>
                                    ...
                                    <RupiahInput
                                        ...
                                        onChange={(raw) =>
                                            form.setData('planned_amount', raw)
                                        }
                                        invalid={!!form.errors.planned_amount}
                                    />
                                ...
                                <div>
                                    ...
                                    <RupiahInput
                                        ...
                                        onChange={(raw) =>
                                            form.setData('actual_amount', raw)
                                        }
                                        invalid={!!form.errors.actual_amount}
                                    />
            ...
            {confirm && (
                ...
                >
                    ...
                    >
                        ...
                        >
                            Anggaran {labelOf(categories, confirm.category)}{' '}
                            periode {confirm.period} akan dihapus.
                        </div>
                        <div
                            style={{ display: 'flex', gap: 10, marginTop: 22 }}
                        >
