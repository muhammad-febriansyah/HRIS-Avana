...
export default function OnboardingIndex({
    ...
    const submitProgram = (event: FormEvent<HTMLFormElement>) => {
        ...
        programForm.submit(OnboardingController.store(), {
    ...
    const toggleTask = (task: TaskRow) => {
        router.post(
            OnboardingController.toggleTask(task.id).url,
            {},
            { preserveScroll: true },
        );
    };
        ...
        <>
            ...
            <div style={{ padding: '28px 32px' }}>
                ...
                >
                    <div>
                        ...
                        >
                            Kelola program orientasi karyawan baru &amp;
                            checklist tugasnya.
                        </div>
                    </div>
                    <button
                                ...
                                >
                                    ...
                                    >
                                        <ActionBtn
                                            ...
                                            label={open ? 'Tutup' : 'Checklist'}
                                            variant="neutral"
                                            onClick={() =>
                                                setExpanded(
                                                    open ? null : program.id,
                                                )
                                            }
                                        />
                                        <ActionBtn
            ...
            {programModalOpen && (
                <ModalShell
                    ...
                    title="Tambah Program Onboarding"
                    subtitle="Mulai program orientasi untuk karyawan baru."
                >
                        ...
                        >
                            ...
                            <div>
                                ...
                                {programForm.errors.start_date && (
                                    <FieldError
                                        message={programForm.errors.start_date}
                                    />
                                )}
                            </div>
                        </div>
                        <ModalActions
                            processing={programForm.processing}
                ...
                <ConfirmModal
                    ...
                    body={
                        <>
                            ...
                            beserta seluruh tugasnya akan dihapus.
                        </>
                    }
    ...
    return (
        <span
            style={{
                ...
                background: done ? 'rgba(22,163,74,.1)' : 'rgba(47,84,201,.1)',
            }}
        >
