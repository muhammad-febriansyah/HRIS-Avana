...
export default function JurnalIndex({
    ...
    const kpiItems = [
        {
            label: 'Total Entri',
            value: String(kpis.total_entries),
            icon: 'book-open',
            color: C.primary,
        },
        {
            label: 'Total Debit',
            value: rp(kpis.total_debit),
            icon: 'arrow-down-left',
            color: C.sky,
        },
        {
            label: 'Total Kredit',
            value: rp(kpis.total_credit),
            icon: 'arrow-up-right',
            color: C.amber,
        },
    ];
                        ...
                        >
                            ...
                            >
                                <AIcon
                                    ...
                                    size={17}
                                    color={kpis.balanced ? C.green : C.red}
                                />
                            </div>
                            <span
                                style={{
                ...
                <tr key={row.id} style={{ borderTop: `1px solid ${C.line}` }}>
                    ...
                    <td
                        style={{
                            ...
                            color: row.debit ? C.text : C.faint,
                        }}
                    >
                    ...
                    <td
                        style={{
                            ...
                            color: row.credit ? C.text : C.faint,
                        }}
                    >
                        {row.credit ? rp(row.credit) : '—'}
                    </td>
