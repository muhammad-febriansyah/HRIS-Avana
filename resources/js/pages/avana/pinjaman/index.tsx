...
export default function PinjamanIndex({
    ...
    const submit = (event: FormEvent<HTMLFormElement>) => {
        ...
        form.post(LoanController.store().url, {
    ...
    const kpiItems = [
        {
            ...
            value: rp(kpis.outstanding_total),
            icon: 'wallet',
            color: C.primary,
        },
        {
            ...
            {modalOpen && (
                ...
                >
                    ...
                    >
                        ...
                        >
                            Buat pengajuan pinjaman untuk seorang karyawan.
                        </div>
