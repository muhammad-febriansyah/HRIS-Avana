...
export default function OffboardingIndex({
    ...
    const submitCase = (event: FormEvent<HTMLFormElement>) => {
        ...
        caseForm.submit(OffboardingController.store(), {
    ...
    const toggleItem = (item: ClearanceRow) => {
        router.post(
            OffboardingController.toggleItem(item.id).url,
            {},
            { preserveScroll: true },
        );
    };
        ...
        <>
            ...
            <div style={{ padding: '28px 32px' }}>
                ...
                >
                    <div>
                        ...
                        >
                            Kelola proses pengunduran diri &amp; checklist
                            clearance antar divisi.
                        </div>
                    </div>
                    <button
                ...
                >
                    {cases.map((item) => {
                        const pct =
                            item.items_total > 0
                                ? Math.round(
                                      (item.items_cleared / item.items_total) *
                                          100,
                                  )
                                : 0;
            ...
            {caseModalOpen && (
                <ModalShell
                    ...
                    title="Tambah Kasus Offboarding"
                    subtitle="Buka proses clearance untuk karyawan yang resign."
                >
                        ...
                        >
                            <div>
                                ...
                                <SearchableSelect
                                    ...
                                    onChange={(v) =>
                                        caseForm.setData('employee_id', v)
                                    }
                                ...
                                />
                                {caseForm.errors.employee_id && (
                                    <FieldError
                                        message={caseForm.errors.employee_id}
                                    />
                                )}
                            </div>
                            <div>
                                ...
                                {caseForm.errors.last_day && (
                                    <FieldError
                                        message={caseForm.errors.last_day}
                                    />
                                )}
                            </div>
                            <div>
                                ...
                                <textarea
                                    ...
                                    style={textareaStyle}
                                />
                                {caseForm.errors.reason && (
                                    <FieldError
                                        message={caseForm.errors.reason}
                                    />
                                )}
                            </div>
                        </div>
                        <ModalActions
                            processing={caseForm.processing}
                ...
                <ConfirmModal
                    ...
                    body={
                        <>
                            ...
                            beserta seluruh item clearance-nya akan dihapus.
                        </>
                    }
            ...
            {settleCase && (
                <ModalShell
                    onClose={() => setSettleCase(null)}
                    title="Hitung Pesangon / Uang Pisah"
                    subtitle={`Perhitungan PP 35/2021 untuk ${settleCase.employee?.name ?? 'karyawan'}.`}
                >
                    <form onSubmit={submitSettlement}>
                        ...
                        >
                            <div>
                                ...
                                {settleForm.errors.reason && (
                                    <FieldError
                                        message={settleForm.errors.reason}
                                    />
                                )}
                            </div>
                            <div>
                                ...
                                <RupiahInput
                                    ...
                                    style={inputStyle}
                                />
                                {settleForm.errors.uph && (
                                    <FieldError
                                        message={settleForm.errors.uph}
                                    />
                                )}
                            </div>
                            <div>
                                ...
                                <RupiahInput
                                    ...
                                    style={inputStyle}
                                />
                                {settleForm.errors.separation_pay && (
                                    <FieldError
                                        message={
                                            settleForm.errors.separation_pay
                                        }
                            ...
                            {settleCase.settlement_breakdown && (
                                ...
                                >
                                    ...
                                    <Row
                                        k={`Masa kerja`}
                                        v={`${settleCase.settlement_breakdown.tenure_years} th`}
                                    />
                                    <Row
                                        k="Uang Pesangon (UP)"
                                        v={rupiah(
                                    ...
                                    <Row
                                        k="UPH"
                                        v={rupiah(
                                            settleCase.settlement_breakdown.uph,
                                        )}
                                    />
                                    <Row
                                        k="Uang Pisah"
                        ...
                        >
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    height: 44,
                                    justifyContent: 'center',
                                    opacity: settleForm.processing ? 0.7 : 1,
                                }}
                            >
                                <AIcon
                                    name="calculator"
    ...
    return (
        <span
            style={{
                ...
                background: done ? 'rgba(22,163,74,.1)' : 'rgba(217,119,6,.1)',
            }}
        >
            {done ? 'Selesai' : 'Proses'}
        </span>
