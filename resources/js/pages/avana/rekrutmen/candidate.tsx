    ...
    return (
        ...
        >
            ...
            <div style={{ minWidth: 0 }}>
                <div
                    style={{ fontSize: 11.5, color: C.faint, marginBottom: 2 }}
                >
                    {label}
                </div>
                <div
...
export default function Candidate({
    ...
    const stageLabel = (value: string): string =>
        stages.find((option: SelectOption) => option.value === value)?.label ??
        value;
                ...
                >
                    ...
                    >
                        ...
                        <StageBadge
                            ...
                            label={stageLabel(applicant.stage)}
                        />
                    </div>
                </div>
                ...
                >
                    ...
                    >
                        ...
                        <div style={cardPad}>
                            ...
                            <div style={{ ...sectionTitle, marginTop: 22 }}>
                                Tautan Sosial
                            </div>
                            <InfoRow
                                icon="linkedin"
                        ...
                        <div style={cardPad}>
                                ...
                                >
                                    <div style={{ gridColumn: '1 / -1' }}>
                                        ...
                                        <input
                                            ...
                                            style={inputStyle}
                                            placeholder="Medical Check Up Umum"
                                        />
                                    </div>
                                    <div>
                                        <label style={fieldLabelStyle}>
                            ...
                            {applicant.medical_checks.length === 0 ? (
                                <EmptyState
                                    icon="stethoscope"
                                    text="Belum ada dokumen pemeriksaan kesehatan"
                                />
                            ) : (
                                applicant.medical_checks.map(
                                    (check: MedicalCheck) => (
                                        <RecordRow
                                            key={check.id}
                                            title={check.title}
                        ...
                        <div style={cardPad}>
                            ...
                            {panel === 'background' ? (
                                ...
                                >
                                    <div>
                                        ...
                                        <select
                                            value={
                                                backgroundForm.data.check_type
                                            }
                                            onChange={(e) =>
                                    ...
                                    <div>
                                        ...
                                        <select
                                            value={backgroundForm.data.status}
                                            onChange={(e) =>
                                                backgroundForm.setData(
                                                    'status',
                                                    e.target.value,
                            ...
                            {applicant.background_checks.length === 0 ? (
                                <EmptyState
                                    icon="shield-check"
                                    text="Belum ada informasi pemeriksaan latar belakang"
                                />
                            ) : (
                                applicant.background_checks.map(
                                    (check: BackgroundCheck) => (
                                        <RecordRow
                                            key={check.id}
                                            title={
                                                BACKGROUND_TYPE_OPTIONS.find(
                                                    (o) =>
                                                        o.value ===
                                                        check.check_type,
                    ...
                    >
                        ...
                        <div style={cardPad}>
                            ...
                            <InfoRow
                                icon="calendar"
                                label="Melamar pada"
                                value={fmtDate(applicant.applied_date)}
                            />
                            <InfoRow
                                icon="briefcase"
                                label="Posisi"
                            ...
                            {applicant.interview_at ? (
                                <InfoRow
                                    ...
                                    value={fmtDate(applicant.interview_at)}
                                />
                            ) : null}
        ...
        >
            ...
            {fileUrl ? (
                <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    style={{ color: C.primary, display: 'inline-flex' }}
                >
