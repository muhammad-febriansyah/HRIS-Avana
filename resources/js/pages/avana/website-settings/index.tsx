...
export default function WebsiteSettings({ settings }: PageProps) {
    ...
    const clearImage = (field: ImageField, hadServerImage: boolean) => {
        ...
        form.setData(
            `remove_${field}` as keyof FormData,
            hadServerImage as never,
        );
        setRemoved((prev) => ({ ...prev, [field]: hadServerImage }));
    };

    const currentUrl = (field: ImageField, url: string | null) =>
        removed[field] ? null : url;
            ...
            <form onSubmit={submit} style={{ padding: '28px 32px' }}>
                ...
                <div style={{ marginBottom: 22 }}>
                    ...
                    <div style={{ fontSize: 14, color: C.muted, marginTop: 4 }}>
                        Logo, favicon, SEO, sosial media, dan informasi kontak
                        situs publik
                    </div>
                </div>
                ...
                <div style={{ ...card, padding: '24px 26px' }}>
                    {tab === 'umum' && (
                        ...
                        >
                            ...
                            >
                                {text('site_name', { placeholder: 'AvanaHR' })}
                            </Field>
                            <Field label="Tagline" error={form.errors.tagline}>
                                {text('tagline', {
                                    placeholder:
                                        'HR modern untuk bisnis Indonesia',
                                })}
                            </Field>
                        </div>
                    )}
                    ...
                    {tab === 'brand' && (
                        <div style={{ display: 'grid', gap: 24 }}>
                            <ImageUpload
                                ...
                                onClear={() =>
                                    clearImage('logo', !!settings.logo_url)
                                }
                            />
                            <ImageUpload
                                label="Favicon"
                    ...
                    {tab === 'sosial' && (
                        ...
                        >
                            ...
                            <Field
                                label="TikTok"
                                error={form.errors.social_tiktok}
                            >
                                {text('social_tiktok', {
                    ...
                    {tab === 'kontak' && (
                        ...
                        >
                            ...
                            >
                                {text('contact_email', {
                                    placeholder: 'halo@avanahr.co.id',
                                    type: 'email',
                                })}
                            </Field>
                            <Field
