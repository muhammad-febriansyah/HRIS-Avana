    ...
    public static function groups(): array
    {
        return [
            ...
            ['title' => 'LAYANAN SAYA', 'items' => [
                ...
                self::leaf('saya-kalender', 'Kalender Saya', 'calendar-days', '/avana/saya/kalender', 'ess', ['own']),
                self::leaf('saya-tugas', 'Tugas Saya', 'clipboard-list', '/avana/saya/tugas', 'ess', ['own']),
                ...
                self::leaf('saya-pembelajaran', 'Pembelajaran Saya', 'graduation-cap', '/avana/saya/pembelajaran', 'ess', ['own']),
                self::leaf('saya-benefit', 'Benefit Saya', 'gift', '/avana/saya/benefit', 'ess', ['own']),
