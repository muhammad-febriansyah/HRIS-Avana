...
return [
    ...
    'attributes' => [
        ...
        // AvanaHR — nama field formulir aplikasi (di luar daftar bawaan
        // laravel-lang). Kunci yang tidak ada di sini tampil apa adanya
        // (snake_case di-"humanize"), jadi cukup field yang dilihat pengguna.
        ...
        'planned_amount' => 'anggaran rencana',
        'actual_amount' => 'realisasi',
        'base_salary' => 'gaji pokok',
        'monthly_deduction' => 'potongan bulanan',
        ...
        'self_score' => 'skor mandiri',
        'manager_score' => 'skor atasan',
        'final_score' => 'skor akhir',
        'calibrated_score' => 'nilai kalibrasi',
        'rating' => 'nilai',
        'feedback_type' => 'jenis umpan balik',
        'review_date' => 'tanggal penilaian',
